...
echo "Backup exists at: $PROJECT_ROOT/shopping_extracted_backup"
...
echo "  Restore from backup: rm -rf $BASE_DIR && cp -r $PROJECT_ROOT/shopping_extracted_backup $BASE_DIR"